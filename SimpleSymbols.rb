...
#letters between them (ie. ++d+===+c++==a) and for the string to be true each letter must be 
#surrounded by a + symbol. So the string to the left would be false. The string will not be 
